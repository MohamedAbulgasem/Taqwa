...
object HighLatitudeCopy {
    ...
    private val WORDS: Map<UiLanguage, Words> = mapOf(
        ...
        UiLanguage.FRENCH to Words(
            ...
            polarLead = "Le soleil ne se lève ni ne se couche ici aujourd’hui. Tous les horaires sont calculés pour la latitude la plus proche où c’est le cas",
        ...
        UiLanguage.INDONESIAN to Words(
            seventh = "Pada musim ini, malam di sini pendek. Subuh dan Isya memakai aturan sepertujuh malam.",
            twilight = "Pada musim ini, malam di sini pendek. Subuh dan Isya memakai aturan sudut senja.",
            middle = "Subuh dan Isya memakai aturan pertengahan malam pada lintang ini.",
            polarLead = "Hari ini matahari tidak terbit maupun terbenam di sini. Semua waktu dihitung untuk lintang terdekat tempat matahari masih terbit dan terbenam",
        ...
        UiLanguage.URDU to Words(
            ...
            polarLead = "آج یہاں سورج نہ طلوع ہوتا ہے نہ غروب۔ سب اوقات قریب ترین اُس عرض بلد کے لیے نکالے گئے ہیں جہاں سورج طلوع اور غروب ہوتا ہے",
        ...
        UiLanguage.BENGALI to Words(
            ...
            polarLead = "আজ এখানে সূর্য ওঠেও না, অস্তও যায় না। সবগুলো সময় নিকটতম সেই অক্ষাংশ ধরে হিসাব করা হয়েছে যেখানে সূর্য ওঠে ও অস্ত যায়",
