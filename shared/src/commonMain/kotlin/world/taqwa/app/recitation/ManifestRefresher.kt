 ...
 * library's reconciliation and it never reports anything: a reader with no network keeps the
 * catalogue they have, which is either yesterday's or the one bundled with the build, and both
 * are correct answers. The only thing a failure costs is a reciter added this morning not
 * appearing until tomorrow.
 */
