 ...
 *
 * Two tabs for now. Qibla was a tab for one iteration and is now a card on the Prayer screen
 * (iteration 8), with the compass itself pushed from there; the Quran tab arrives with slice 2.
 * [PRAYER]'s root is still [Screen.Today] in code: only the label changed, and renaming the
 * screen, its view model and its tests would be churn for a word.
 *
