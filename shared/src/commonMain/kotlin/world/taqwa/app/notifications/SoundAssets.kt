...
object SoundAssets {
     ...
     *
     * **PROVISIONAL.** The Aaqib Azeez and Besim Azemi rows were measured on the provisional cuts
     * of 12 September 2026, not on the final loudness-matched clips; they will be re-measured when
     * those land, and both `takbir` figures are round numbers precisely because they are cuts to
     * length rather than to a phrase boundary. The original's figures are the real measurements.
     */
    ...
    private val CLIPS: Map<AdhanVoice, VoiceClips> = mapOf(
        ...
        AdhanVoice.AZEEZ to VoiceClips(takbir = 16.0.seconds, adhan30 = 30.0.seconds, adhanFull = 86.60.seconds),
        AdhanVoice.AZEMI to VoiceClips(takbir = 16.0.seconds, adhan30 = 30.0.seconds, adhanFull = 242.70.seconds),
    )
