...
Mêmes champs et mêmes limites que la fiche anglaise ; `tools/store-listing-check.py fr`
les vérifie. Copiez chaque bloc tel quel dans la console.

## Google Play

### Title (30)
Taqwa : Prière, Coran & Qibla
...
• Des traductions en anglais, français, turc, indonésien, ourdou et bengali, ainsi qu’un tafsir en arabe, affichées sous chaque verset.
...
QIBLA
• Une boussole pointant vers La Mecque, avec l’azimut et la distance, et un mot honnête quand la boussole du téléphone n’est pas fiable.

TASBIH
• Un compteur de dhikr, avec la série d’après la prière intégrée.
...
(Si Apple dit que le nom est déjà pris : « Taqwa : Prière, Coran & Qibla ».)
...
### Keywords (100)
horaires,salat,adhan,azan,quran,mushaf,kibla,islam,musulman,récitation,tasbih,dhikr,ramadan,namaz
...
1. Les horaires là où vous êtes
2. L’adhan, et un rappel avant
3. Tout le Coran, avec traduction
4. Lisez comme dans le Mushaf
5. Dix récitateurs, hors ligne
6. Trouvez la qibla
7. Comptez vos dhikr
8. Sombre, et en sept langues
