...
#   ONLY="2-notifications" tools/store/capture-ios.sh <udid> en ar …   re-shoots just those
#
...
for L in "$@"; do
  ...
  want 1-prayer && { url "taqwa://recite/screen?name=prayer" 2; shot 1-prayer; }
  want 2-notifications && { url "taqwa://recite/tahajjud?name=on" 2; url "taqwa://recite/screen?name=notifications" 3; shot 2-notifications; url "taqwa://recite/tahajjud?name=off" 1; }
  want 3-reader && { url "taqwa://ayah/2/255" 4; shot 3-reader; }
  want 4-mushaf && { url "taqwa://recite/mode?name=mushaf" 1; url "taqwa://ayah/2/255" 4; shot 4-mushaf; }
  want 5-recitation && { url "taqwa://recite/mode?name=translation" 1; url "taqwa://ayah/2/255" 3; url "taqwa://recite/load?surah=2&ayah=255&reciter=ar.alafasy" 5; shot 5-recitation; url "taqwa://recite/stop" 1; }
  want 6-qibla && { url "taqwa://recite/screen?name=qibla" 4; shot 6-qibla; }
  want 7-tasbeeh && { url "taqwa://recite/screen?name=tasbeeh" 3; shot 7-tasbeeh; }
  want 8-dark && { url "taqwa://recite/theme?name=dark" 2; url "taqwa://recite/screen?name=prayer" 3; shot 8-dark; }
